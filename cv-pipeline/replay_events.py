...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--target-url", help="Preferred explicit backend ingestion URL (local Spring Boot or Render)")
...
def main() -> None:
    ...
    target_url = args.target_url or args.url or "http://localhost:8080/api/risk-events"
