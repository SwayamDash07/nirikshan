...
type Recommendation = { id: number; zoneId?: number | null; zoneName?: string | null; type: "OPEN_ROUTE"; message: string; severity: RiskLevel; createdAt: string; status: "PENDING" | "ACKNOWLEDGED" | "DISMISSED" };
