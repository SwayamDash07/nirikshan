...
function App() {
  ...
  const resolveAlert = async (id: number) => {
    try {
      const response = await fetch(`${API_BASE}/api/alerts/${id}/resolve`, { method: "PATCH" });
      if (!response.ok) throw new Error(`Backend returned ${response.status} while resolving alert`);
  ...
  return (
    <main className={styles.shell}>
      <header className={styles.navbar}>
        ...
        <nav><a href="#dashboard">Dashboard</a><a href="#zones">Zones</a><a href="#alerts">Alerts <span>{activeAlerts}</span></a><a href="#about">About</a><a href="/admin">Admin upload</a><a href="/alerts">Citizen view</a></nav>
