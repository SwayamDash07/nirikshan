...
public final class AuthResponses { private AuthResponses(){}
 public record UserInfo(Long id,String email,String name,UserRole role,boolean mustChangePassword,Long assignedZoneId,String assignedZoneName,Instant createdAt,boolean active){}
