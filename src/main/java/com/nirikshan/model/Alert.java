...
public class Alert {
    ...
    public Alert(Zone zone, Instant timestamp, String message, RiskLevel severity, RiskEventSource source) {
        this(zone, timestamp, message, severity); this.source = source == null ? RiskEventSource.LIVE : source;
    }
